...
function Footer () {
    ...
    return (
        ...
        <img src="https://res.cloudinary.com/practicaldev/image/fetch/s--nkU0GvK3--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://i.postimg.cc/SQCCBw0Q/graphql-with-text-small.png" alt="graphql" width="40" height="40"/>
        </a>
        <a href="https://www.apollographql.com/docs/apollo-server/" target="_blank" rel="noreferrer">
        <img src='https://seeklogo.com/images/A/apollo-logo-DC7DD3C444-seeklogo.com.png' alt="apollo" width="40" height="40" />
        </a>
        </div>
        <div className="tech-col">
        ...
        <a href="https://nodejs.org" target="_blank" rel="noreferrer"> <img src="https://www.vectorlogo.zone/logos/nodejs/nodejs-icon.svg" alt="nodejs" width="40" height="40"/>
        </a>
